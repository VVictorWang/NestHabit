...
public class NetworkUtils {
    ...
    public static boolean isMobileEnabled(Context context) {
        try {
            Method getMobileDataEnabledMethod = ConnectivityManager.class.getDeclaredMethod
        ...
        if (connectivity != null) {
            ...
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    ...
                    LogUtils.i(TAG, "NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i]
    ...
    public static final boolean isGpsEnabled() {
        LocationManager locationManager = (LocationManager) AppUtils.getAppContext()
