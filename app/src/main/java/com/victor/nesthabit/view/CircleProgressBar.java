...
//	private LinearGradient linearGradient;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        isSetBottomContent = a.getBoolean(R.styleable.CircleProgressBar_is_set_bottom_content,
                false);
        ...
        midProgressColor = a.getColor(R.styleable.CircleProgressBar_mid_progress_color, Color
                .GREEN);
        bottomcontentColor = a.getColor(R.styleable.CircleProgressBar_bottom_content_color,
                topTitleColor);
        toptitleTextSize = a.getDimension(R.styleable.CircleProgressBar_top_title_text_size, 15);
        currentProgressTextsize = a.getDimension(R.styleable
                .CircleProgressBar_current_progress_text_size, 55);
        bottomcontentTextSize = a.getDimension(R.styleable
                .CircleProgressBar_bottom_content_text_size, 15);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(hideRect, startAngle, currentProgress / maxProgress * 360, false,
                progressPaint);
