...
public class RecordActivity extends BaseActivity implements RecordModel.View{
    ...
    private RecordModel.Presenter mRecordActivityPresenter;
    ...
    @Override
    public void setPresenter(RecordModel.Presenter presenter) {
